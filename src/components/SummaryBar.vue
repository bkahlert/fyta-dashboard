...
<template>
  ...
  >
    ...
    <span v-if="warn" class="badge badge-warning badge-sm gap-1"> ⚠️ {{ warn }} bald gießen </span>
    <span v-if="ok" class="badge badge-success badge-sm gap-1"> ✅ {{ ok }} gut versorgt </span>
  </div>
</template>
